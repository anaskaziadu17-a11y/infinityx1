          ...
          return (
            <div key={index}>
              ...
              {isNewDay && (
                ...
                >
                  <span className="px-6 py-2 bg-gradient-to-r from-primary to-accent rounded-full text-foreground font-bold font-display text-lg">
                    Day {item.day}
                  </span>
                </motion.div>
              )}
              ...
              >
                ...
                <div className={`w-full md:w-5/12 ${isLeft ? "md:text-right" : "md:text-left"}`}>
                  <div className="glass-card p-5 card-hover-lift inline-block">
